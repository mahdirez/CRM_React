...
const BillingSection = ({ data }: BillingSectionProps) => {
    ...
    const handleSubmit = () => {
        handleEditClose()
        toast.push(
            <Notification title={'با موفقیت به روز شد!'} type="success" />,
            {
    ...
    return (
        <>
            <h6 className="mb-4">تاریخچه خرید</h6>
            <Table>
                <TBody>
                    {table
                        .getRowModel()
            ...
            <h6 className="mt-8">روش‌های پرداخت</h6>
